...
static const u1_t APPEUI[8]  = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // REVERSE ORDER
static const u1_t DEVEUI[8]  = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x04, 0xAE}; // REVERSE ORDER
static const u1_t APPKEY[16] = {0x3A, 0xE5, 0xB6, 0x9B, 0x4B, 0x5B, 0xEA, 0x70, 0x57, 0xEE, 0x14, 0xF5, 0xD1, 0xD9, 0x4B, 0xBE};
